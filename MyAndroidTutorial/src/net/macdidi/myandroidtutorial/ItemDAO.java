...
public class ItemDAO {
    ...
    public void sample() {
        ...
        Item item1 = new Item(1, new Date().getTime(), Colors.BLUE, "吳寶春", "麵包", "", 0, 0, 0);
        Item item2 = new Item(2, new Date().getTime(), Colors.PURPLE, "天仁茗茶", "茶", "", 0, 0, 0);
        Item item3 = new Item(3, new Date().getTime(), Colors.GREEN, "Starbucks", "咖啡", "", 0, 0, 0);
        Item item4 = new Item(4, new Date().getTime(), Colors.ORANGE, "Smith&Hsu tea", "司康", "", 0, 0, 0);
